...
class Pelt:
    ...
    juvenile_long_poses = [x for x in all_poses if "juvenile_long" in x and "sick" not in x]
    juvenile_short_poses = [x for x in all_poses if "juvenile" in x and "long" not in x and "sick" not in x]
