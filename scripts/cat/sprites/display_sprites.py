...
def generate_sprite(
    ...
    if (
        ...
        if age in (CatAge.KITTEN, CatAge.JUVENILE, CatAge.ADOLESCENT):
            ...
            elif age == (CatAge.KITTEN or CatAge.JUVENILE):
    ...
    try:
        ...
        if cat.pelt.eye_colour2 != None:
            heterochromia_name = f"{sprites.EYE_DATA['spritesheet']}{cat.pelt.eye_colour2}{cat_sprite}"
